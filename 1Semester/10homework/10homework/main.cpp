...
bool thereAreUncheckedCities(int arrayOfTowns[], int numberOfTowns);

void initialization(int &numberOfTowns, int **&matrix, int &maxLength) {
...
int main(int argc, char** argv) {
    ...
    initialization(numberOfTowns, matrix, maxLength);
    ...
    int dop = 0;
    for (int j = 0; j < numberOfCountries; ++j) {
        for (int i = 0; i < numberOfTowns && thereAreUncheckedCities(arrayOfTowns, numberOfTowns); ++i) {
